...
export function NotificationProvider({
   ...
   * IMPORTANT:
   *
   * The provider is the single owner of the
   * notification WebSocket connection.
   *
   * Individual components must never connect
   * or disconnect this singleton.
   */
  useEffect(() => {
  ...
  /*
   * REST fallback while realtime is unavailable.
   */
  useEffect(() => {
    if (
      socketStatus ===
